...
const Classes = ({ text }) => {
	...
	return (
		<section css={styles} className='ourClasses' id='ourClasses'>
			...
			<Icon />
			<p>
				GenxGym is a diverse fitness community that welcomes individuals of all
				ages and fitness levels.
				<br /> We offer customized workout programs, state-of-the-art
				facilities,
				<br /> and a supportive environment to help you achieve your fitness
				goals.
			</p>
			<Container>
